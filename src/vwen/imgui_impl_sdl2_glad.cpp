...
void ImGui_ImplSdlGLad_RenderDrawLists(ImDrawData* draw_data)
{
...
void ImGui_ImplSdlGLad_CreateFontsTexture()
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
#undef OFFSETOF
    ...
    ImGui_ImplSdlGLad_CreateFontsTexture();
...
bool    ImGui_ImplSdlGLad_Init(SDL_Window* window)
{
    ...
    io.RenderDrawListsFn = ImGui_ImplSdlGLad_RenderDrawLists;   // Alternatively you can set this to NULL and call ImGui::GetDrawData() after ImGui::Render() to get the same ImDrawData pointer.
